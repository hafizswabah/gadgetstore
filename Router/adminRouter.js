...
Router.post('/addProduct',upload.fields([{name:'mainImage', maxCount:1},{name:'subImage', maxCount:12}]), verifyadmin,addProduct)
...
Router.post('/edit-product',upload.fields([{name:'mainImage', maxCount:1},{name:'subImage', maxCount:12}]) ,verifyadmin, editProduct)
...
Router.post('/add-offer', upload.single('image'),verifyadmin, offer)
Router.get('/edit-offer/:id',verifyadmin, editbannerpage)
Router.get('/delete-offer/:id',verifyadmin, deletebanner)
Router.post('/edit-banner', upload.single('image'),verifyadmin, editbanner)
